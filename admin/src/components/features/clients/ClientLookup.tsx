...
export const ClientLookup: React.FC = () => {
  ...
  // Real-time refresh on CSV upload or data version bump (kiosk check-ins,
  // help requests, status changes — anything that bumps the version).
  useDataEvent('data:csvImported', () => loadClients());
  useDataEvent('data:dataVersionChanged', () => loadClients());
  ...
  return (
    <Box
      ...
      minW="0"
    >
      <VStack spacing={3} align="stretch" h="full" minH="0" w="full" maxW="100%" minW="0">
        ...
        <VStack spacing={3} align="stretch" w="full" maxW="100%" minW="0" flex="1" minH="0">
          <Input
