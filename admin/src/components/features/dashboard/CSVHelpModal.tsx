...
const CSVHelpModal: React.FC<CSVHelpModalProps> = ({ isOpen, onClose }) => {
  ...
  const exampleDate = new Date().toLocaleDateString('en-CA', { timeZone: tz });
  return (
          ...
          <VStack spacing={6} align="stretch">
            ...
            <Box>
              ...
              <List spacing={2} fontSize="sm">
                ...
                <ListItem color="gray.800">
                  <ListIcon as={FiCheckCircle} color="green.500" />
                  Save the file as <Code color="admin.primary">data_YYYY-MM-DD.csv</Code> (example: data_{exampleDate}.csv)
                </ListItem>
              </List>
            </Box>
