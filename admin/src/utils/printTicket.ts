 ...
 */
/**
 * Shared tooltip copy used by every print-ticket trigger in the admin panel.
 * Keep all four print buttons (RecentCheckInsList, CheckInsList,
 * CheckInDetailModal, ClientDetailHeader) on this same string so the UX
 * doesn't drift. If you change this, every print button updates.
 */
export const PRINT_TICKET_TOOLTIP =
  'Print ticket — opens in a new window. Set printer to Landscape for best results.';

/** Standard icon size for inline print-ticket icon buttons (px). */
export const PRINT_TICKET_ICON_SIZE = '16px';
