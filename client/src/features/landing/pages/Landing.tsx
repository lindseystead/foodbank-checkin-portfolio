...
const Landing: React.FC = () => {
  ...
  // Clear any leftover PII from previous/abandoned check-in sessions
  React.useEffect(() => {
  ...
  const handleContinue = () => {
    ...
    toast.closeAll();
    navigate(buildTenantPath(slug, '/initial-check-in'));
  };
    ...
    <PageLayout showBackButton={false} isScrollable={false}>
      ...
      >
        ...
        <Box 
          ...
          pt={0}
        >
          <PrimaryButton onClick={handleContinue} maxW={{ base: '100%', md: '240px' }}>
            {t('common.continue')}
          </PrimaryButton>
        </Box>
      </VStack>
