...
import type { CheckInResponse } from '../../../shared/types/CheckInResponse';
...
export interface CompleteCheckInData {
  ...
  // Next appointment data (auto-generated by admin system)
...
// Get a specific check-in
  static async getCheckIn(checkInId: string): Promise<CheckInResponse> {
    try {
      const response = await api(`/checkin/${checkInId}/summary`);
      const result: CheckInResponse = await response.json();
      return result;
    } catch (error) {
